...
function slider(slider) {
    ...
    // Initiate transition slide time.
    slider.transition = slider.duration;
    ...
    slideshow.find('.ssBtn-right').click(function() {
        ...
        slider.transition = TRANS_TIME; // Slides transition time when next btn is clicked.
    ...
    slideshow.find('.ssBtn-left').click(function() {
        ...
        slider.transition = TRANS_TIME; // Slides transition time when previous btn is clicked.
...
function next(slider) {
    ...
    slider.slideshow.find('.pagerDot').css("color", slider.COLOR);
...
function clickPagerDot(index, slider) {
    ...
    slider.transition = slider.TRANS_TIME; // Slides transition time when a pager dot is clicked.
...
function zIndexCall(slider) {
    ...
    slider.transition = slider.duration; // Go back to set value.
}

// Define slides transition effect.
function defineEffect(slider) {
    var effect = slider.effect;
    var duration = slider.transition;
